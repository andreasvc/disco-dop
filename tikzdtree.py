...
def main():
	...
	(ROOT (S (ADV 0) (VVFIN 1) (VP (PP (APPR 2) (PIAT 3) (NN 4)) (NP (ART 8) \
		(NN 9)) (VZ (PTKZU 10) (VVINF 11))) (NP (AP (PTKNEG 5) (ADJA 6)) \
		(NN 7))) ($. 12))
	(ROOT (S (S|<NP> (NP (AP (PTKNEG 5) (ADJA 6)) (NN 7)) (S|<VP> (VP (VP|<PP> \
		(PP (PP|<NN> (NN 4) (PP|<PIAT> (PIAT 3) (PP|<APPR> (APPR 2))))) \
		(VP|<NP> (NP (ART 8) (NN 9)) (VP|<VZ> (VZ (PTKZU 10) (VVINF 11)))))) \
		(S|<ADV> (ADV 0) (S|<VVFIN> (VVFIN 1)))))) ($. 12))
	...
	Vielmehr/ADV scheinen/VVFIN auf/APPR allen/PIAT Seiten/NN nicht/PTKNEG \
		unerhebliche/ADJA Eigeninteressen/NN das/ART Handeln/NN zu/PTKZU \
		bestimmen/VVINF ./$.
	Vielmehr/ADV scheinen/VVFIN auf/APPR allen/PIAT Seiten/NN nicht/PTKNEG \
		unerhebliche/ADJA Eigeninteressen/NN das/ART Handeln/NN zu/PTKZU \
		bestimmen/VVINF ./$.
	...
	for n, tree, sent in zip(count(1), trees, sents):
		print "tree", tree
		print "sent", sent, "\n"
		codecs.open("/tmp/tree%d.tex" % n, "w", encoding='utf-8').write(
				tikzdtree(tree, sent))
